      ...
      <div className="max-w-3xl mx-auto px-4 pt-3 pb-6">
        ...
        <div className="space-y-6">
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-600">
              <li>
                ...
                <span className="text-gray-500">
                  (your email will only be used to notify you as a winner!)
                </span>
              </li>
              <li>
                Check out your unique bingo card and plot your exploration!
              </li>
              <li>Visit as many venues as you can during Restaurant Week</li>
              <li>
                Check in at each location you visit -{" "}
                <span className="italic">
                  Every {GAME_CONFIG.raffle.restaurantsPerEntry} check-ins = (1)
                  entry for the &lsquo;Top Taster&rsquo; $500 prize package!
                </span>
              </li>
            </ol>
          </section>
          ...
          <section className="card p-6 border-l-4 border-[#ff5436]">
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-600">
              <li>
                Click the &ldquo;Check In&rdquo; button at the top of your
                screen
              </li>
              <li>Ask for the secret code</li>
              <li>Fill in the code manually</li>
              <li>
                Your visit will be recorded and your bingo card updated for each
                visit
              </li>
            </ol>
            <p className="mt-6 p-3 bg-[#ff5436]/5 rounded-lg border border-[#ff5436]/10 text-gray-600">
              You can track your progress and plot your exploration through the
              interactive map and using your digital bingo card. Watch as your
              card fills up and your raffle entries increase!
            </p>
          </section>
          ...
          {!user && (
            <section className="card p-8 bg-gradient-to-r from-[#ff5436]/5 to-coral-50 border-2 border-[#ff5436]/20 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Sign up or log in now to get your unique bingo card and start
                earning raffle entries!
              </p>
          ...
          {user && (
            <section className="card p-8 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Welcome back! Head to your dashboard to check your bingo card
                and start checking in at restaurants.
              </p>
              <Link href="/">
