...
import {
  RESTAURANT_WEEK_CONFIG,
  RestaurantWeekUtils,
} from "@/config/restaurant-week";
...
export default function CheckInModal({
  ...
  const isDevEnvironment =
    RestaurantWeekUtils.isDevelopmentOverrideEnvironment();
        ...
        {success ? (
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              Great job! Your bingo card and map have been updated with your
              visit.
            </p>
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!canSubmitCheckIn && (
              <div className="text-sm text-gray-700 bg-gray-100 p-3 rounded-md border border-gray-200">
                Check-ins are currently closed. You can still log in now and be
                ready when Restaurant Week starts.
              </div>
            )}
